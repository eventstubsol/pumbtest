...
const messageheader = (props) => {
  ...
  if(props.type === "user") {
    ...
    if(props.item && typeof props.item.getName === "function" && !props.item.icon && typeof props.item.getGuid === "function") {
  ...
  if(!props.item.blockedByMe && props.audiocall && props.type === "user") {
    audioCallBtn = (<span onClick={() => props.actionGenerated("audioCall")} className="cc1-chat-win-con-opt call"></span>);
  }

  if(!props.item.blockedByMe && props.videocall && props.type === "user") {
